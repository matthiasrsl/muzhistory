 ...
 * Author and source: https://github.com/miohtama/Krusovice/blob/master/src/tools/fade.js
 */


fadeIn = function (audio, rampTime, targetVolume, tick) {
    //
    if (!targetVolume) {
        targetVolume = 1;
    }
 ...
 *
 */
fadeOut = function (audio, rampTime, targetVolume, tick) {
